                ...
                <GridItem xs={12} sm={12} md={8}>
                    <Card>
                        <CardHeader color="info">
                            <h4 className={classes.cardTitleWhite}>Check Product availability</h4>
                            <p className={classes.cardCategoryWhite}>Please provide product type to check total availability</p>
                        </CardHeader>
                        <CardBody>
                            <GridContainer>
